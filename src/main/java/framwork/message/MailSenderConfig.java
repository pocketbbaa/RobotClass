...
public class MailSenderConfig {
     ...
     */
    public MailSenderConfig(String sMTPMailHost, String subject, String content, String fromMail) {
        super();
     ...
     * @param fromMail 发送人地址
     */
    public MailSenderConfig(String sMTPMailHost, String username, String password, String subject, String content, String fromMail) {
        super();
        SMTPMailHost = sMTPMailHost;
